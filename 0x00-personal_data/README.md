...
2. `redaction`: a string representing by what the field will be obfuscated
3. `message`: a string representing the log line
4. `separator`: a string representing by which character is separating all fields in the log line (`message`)
